...
dots_configure_brews() {
    ...
    if [[ -z "${dots_continue}" ]]; then
        ...
        dots_erase_lines 1
        dots_brew_install "colima"
        dots_brew_install "ddev/ddev/ddev"
        dots_brew_install "docker"
        dots_brew_install "docker-compose"
        dots_brew_install "git-flow"
        dots_brew_install "git"
        dots_brew_install "jq"
        dots_brew_install "ngrok/ngrok/ngrok"
        dots_brew_install "php"
        dots_brew_install "php@8.1"
        dots_brew_install "shivammathur/php/php@7.4"
